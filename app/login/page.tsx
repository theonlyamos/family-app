...
import { Heart, Eye, EyeOff, Loader2, Mail, Lock, ArrowLeft } from "lucide-react";
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center my-12 lg:my-0">
          <div className="max-w-md">
            ...
            <blockquote className="font-serif text-3xl lg:text-4xl text-[var(--auth-panel-foreground)] leading-[1.3] tracking-tight mb-6">
              ...
              <span className="italic text-[var(--auth-panel-accent)]"> masterpieces</span>."
            </blockquote>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium text-[var(--auth-panel-foreground)]">George Santayana</p>
                <p className="text-sm text-[var(--auth-panel-muted)]">Philosopher & Poet</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[var(--auth-form-bg)] px-4 text-muted-foreground transition-colors duration-300">Or continue with email</span>
            </div>
          </div>
